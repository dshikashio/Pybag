...
//
// ====================================================================
__int64 __stdcall DisasmOrig (PDISASM pMyDisasm) {
...
__int64 __stdcall Disasm(char *data, long maxlen, 
                         unsigned __int64 VirtualAddr,
                         long Archi, long Options,
                         PDISASM pDisAsm)
{
    pDisAsm->EIP = (unsigned long long)data;
    pDisAsm->SecurityBlock = maxlen;
    pDisAsm->VirtualAddr = VirtualAddr;
    pDisAsm->Archi = Archi;
    pDisAsm->Options = Options;

    return DisasmOrig(pDisAsm);
}
// ====================================================================
//
// ====================================================================
