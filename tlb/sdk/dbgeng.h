...
//
//----------------------------------------------------------------------------
#define ERROR_DBG_CANCELLED 0xC00004C7
#define ERROR_DBG_TIMEOUT   0xC00005B4
...
#define DEBUG_ENGIGNORE_DBGHELP_VERSION      0x00000001
#define DEBUG_ENGIGNORE_EXTENSION_VERSIONS   0x00000002
// If neither allow nor disallow is specified
// the engine will pick one based on what kind
// of debugging is going on.
#define DEBUG_ENGALLOW_NETWORK_PATHS         0x00000004
#define DEBUG_ENGDISALLOW_NETWORK_PATHS      0x00000008
#define DEBUG_ENGNETWORK_PATHS               (0x00000004 | 0x00000008)
// Ignore loader-generated first-chance exceptions.
#define DEBUG_ENGIGNORE_LOADER_EXCEPTIONS    0x00000010
...
// WaitForEvent.
#define DEBUG_ENGINITIAL_BREAK               0x00000020
// Break in on the first module load for a debuggee.
#define DEBUG_ENGINITIAL_MODULE_BREAK        0x00000040
...
#define DEBUG_ENGFINAL_BREAK                 0x00000080
...
#define DEBUG_ENGNO_EXECUTE_REPEAT           0x00000100
...
#define DEBUG_ENGFAIL_INCOMPLETE_INFORMATION 0x00000200
...
#define DEBUG_ENGALLOW_READ_ONLY_BREAKPOINTS 0x00000400
...
#define DEBUG_ENGSYNCHRONIZE_BREAKPOINTS     0x00000800
// Disallows executing shell commands through the
// engine with .shell (!!).
#define DEBUG_ENGDISALLOW_SHELL_COMMANDS     0x00001000
...
#define DEBUG_ENGDEBUGGING_SENSITIVE_DATA    0x00400000
// When opening .cab or .zip files, if there is a trace (.run file), open
// it instead of any other dump files in the archive.
#define DEBUG_ENGPREFER_TRACE_FILES          0x00800000
#define DEBUG_ENGALL                         0x00EFFFFF
...
typedef HRESULT (CALLBACK* PDEBUG_EXTENSION_INITIALIZE)
    ( PULONG Version, _Out_ PULONG Flags);
...
typedef void (CALLBACK* PDEBUG_EXTENSION_NOTIFY)
    ( ULONG Notify, _In_ ULONG64 Argument);
...
typedef HRESULT (CALLBACK* PDEBUG_EXTENSION_CALL)
    ( PDEBUG_CLIENT Client, _In_ PCSTR Args);
